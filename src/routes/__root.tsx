  ...
  head: () => ({
    meta: [
      ...
      { title: "Manpaanai Chettinadu Virundhu | Chettinad Restaurant in Vandalur" },
      {
        name: "description",
        content:
          "Authentic Chettinad and South Indian cuisine at Manpaanai Chettinadu Virundhu, GST Road, Vandalur, Chennai.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Manpaanai Chettinadu Virundhu" },
      { property: "og:locale", content: "en_IN" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#7a3521" },
    ],
    links: [
      {
        rel: "stylesheet",
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Restaurant serving authentic Chettinad and South Indian cuisine in Vandalur, Chennai.",
          servesCuisine: ["Chettinad", "South Indian", "Indian"],
          priceRange: "₹₹",
